        ...
        <Section id="projects" title="Projects" muted>
          <div className="grid gap-6 lg:grid-cols-2">
            {projects.map((project) => (
              <article key={project.title} className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm transition hover:border-teal-300 dark:border-slate-800 dark:bg-slate-950 dark:hover:border-teal-700 sm:p-8 flex flex-col justify-between">
                <div>
                ...
                <div className="mt-6 flex flex-wrap items-center gap-3">
                  {project.github && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 rounded-md bg-signal px-4 py-2 text-sm font-semibold text-white transition hover:bg-teal-800"
                    >
                      <Github size={16} />
                      View Code
                    </a>
                  ...
                  {project.demo && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 rounded-md border border-signal px-4 py-2 text-sm font-semibold text-signal transition hover:bg-teal-50 dark:text-teal-200 dark:hover:bg-teal-950/40"
                    >
